        ...
        <div className="card mb-3 cardCart">
            <div className="row g=0">
                <div className="col-md-4">
                    <img src={item.img} alt={`Imagen de ${item.title}`} className="img-fluid rounded-start"/>
                </div>
                <div className="col-md-8">
                    <div className="card-body">
                        ...
                        <ItemCount ValInicial={1} stock={item.stock} onAdd={onAdd} textBoton="Actualiza tu pedido"/>
